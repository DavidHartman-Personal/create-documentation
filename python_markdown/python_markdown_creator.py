...
This script contains functions that are used to create markdown files.
...
def create_markdown_file(file_path: Path = MARKDOWN_FILE_DIR / "example.md", force_overwrite=False):
    ...
    md_file.new_paragraph(
        "This is an example of markdown file created using mdutils python package. In this example you "
    ...
    md_file.new_paragraph(
        "**IMPORTANT:** some features available on this library have no effect with the GitHub Markdown "
    ...
    md_file.new_paragraph(
        "If you have defined some headers of level 1 and 2, you can create a table of contents invoking "
    ...
    md_file.insert_code(
        "md_file.new_paragraph(\"Using ``new_paragraph`` method you can very easily add a new paragraph\" \n"
    ...
    md_file.new_paragraph(
        "Using ``new_paragraph`` method you can very easily add a new paragraph on your markdown file. "
    ...
    md_file.insert_code(
        "md_file.new_line(md_file.new_reference_image(text='{}', path='{}', reference_tag='im'))".format(image_text,
                                                                                                       path))
...
def main():
    print(str(PYCHARM_ROOT_DIR))
    print(str(PROJECT_ROOT_DIR))
    print(str(MARKDOWN_FILE_DIR))
    print(str(MARKDOWN_FILE_DIR / "example.md"))
